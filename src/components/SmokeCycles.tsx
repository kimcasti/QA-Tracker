...
const SMOKE_CYCLE_DEFAULTS = {
  environment: Environment.TEST,
  identifiedRisks: ['high-regression-risk', 'ui-ux-changes'],
  exitCriteria: ['all-executed', 'no-critical-bugs'],
  helperText: 'Pensado para validar flujos criticos rapidamente antes de seguir con mas cobertura.',
};
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-start gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-orange-50 text-sm font-bold text-orange-700">
          {step}
        </div>
        <div>
...
export default function SmokeCycles({ projectId }: { projectId?: string }) {
  ...
  const watchedBuildVersion = Form.useWatch('buildVersion', form) as string | undefined;
  const watchedNote = Form.useWatch('note', form) as string | undefined;
  ...
  const smokeModuleOptions = Array.from(
    new Set(smokeFuncs.map(item => item.module).filter(Boolean)),
  )
  ...
  const smokePlanningSteps = useMemo(() => {
    const sections = [
      {
        key: 'general',
        label: 'General',
      ...
      },
      {
        key: 'scope',
        label: 'Alcance',
        complete: planningScopeItems.length > 0,
      },
      {
        key: 'environment',
        label: 'Ambiente',
        complete: Boolean(watchedEnvironment),
      },
      {
        key: 'risks',
        label: 'Riesgos',
        complete: watchedIdentifiedRisks.length > 0,
      },
      {
        key: 'criteria',
        label: 'Criterios',
        complete: watchedExitCriteria.length > 0,
      },
      {
        key: 'create',
        label: editingCycle ? 'Guardar' : 'Crear',
        complete: false,
      },
    ];
  ...
  const handleOpenModal = () => {
    ...
    form.setFieldsValue({
      ...
      note: '',
      tester: [],
      environment: SMOKE_CYCLE_DEFAULTS.environment,
      buildVersion: '',
      browser: undefined,
      ...
      osVersion: '',
      resolution: '',
      identifiedRisks: SMOKE_CYCLE_DEFAULTS.identifiedRisks,
      exitCriteria: SMOKE_CYCLE_DEFAULTS.exitCriteria,
    });
    setIsModalOpen(true);
  };
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 text-sm text-slate-500">
                        Contexto que justifica este smoke antes de ejecutar.
                      </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                <div className="text-sm font-semibold text-slate-800">
                  Los ciclos de smoke se basan en las funcionalidades registradas como alcance
                  crítico del proyecto.
                </div>
                <div className="mt-1 text-sm text-slate-500">
                  QA Tracker usa esas funcionalidades para validar rápidamente los flujos esenciales
                  y dejar trazabilidad del resultado operativo del ciclo en un solo lugar.
                </div>
              </div>
            </div>
          </Card>
        ...
        >
          ...
          <div className="space-y-5">
            <PlanningSectionCard
              ...
              subtitle="Completa el contexto base del smoke y el ambiente tecnico donde se correra."
            >
              <Row gutter={16}>
                <Col span={8}>
                  <Form.Item
            ...
            <PlanningSectionCard
              ...
              subtitle="Revisa cobertura, modulos implicados y selecciona las funcionalidades que entran en el smoke."
            >
            ...
            <PlanningSectionCard
              ...
              subtitle="Deja explicitado el riesgo que justifica el smoke antes de ejecutarlo."
            >
            ...
            <PlanningSectionCard
              ...
              subtitle="Define la regla minima para cerrar el smoke o seguir investigando."
            >
